...
def generate_launch_description():
	...
	model_urdf1_file_path = 'rsc/sdf/car_body_susp.sdf'
	model_urdf2_file_path = 'rsc/sdf/car_body.sdf'
	...
	first_model_path = os.path.join(pkg_share, model_urdf1_file_path)
	second_model_path = os.path.join(pkg_share, model_urdf2_file_path)
	...
	spawn_model1_cmd = Node(
	package='gazebo_ros', 
	executable='spawn_entity.py',
	arguments=['-entity', 'spring_damper_system1', 
				'-file', first_model_path,
				'-x', '0.0',
				'-y', '0.0',
				'-z', '0.65',
				'-R', '0.0',
	...
	spawn_model2_cmd = Node(
	package='gazebo_ros', 
	executable='spawn_entity.py',
	arguments=['-entity', 'spring_damper_system2', 
				'-file', second_model_path,
				'-x', '2.0',
				'-y', '0.0',
				'-z', '0.65',
				'-R', '0.0',
	...
	ld.add_action(spawn_model1_cmd)
	ld.add_action(spawn_model2_cmd)
